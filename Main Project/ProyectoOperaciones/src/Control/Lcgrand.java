...
public class Lcgrand {
    ...
    private final static int MODLUS=2147483647;
...
static long zrng[] = {1,
    ...
    private static void lcgrandst(long zset, int stream) /* Set the current zrng for stream
     "stream" to zset. */ {
        zrng[stream] = zset;
    }

    private static long lcgrandgt(int stream) /* Return the current zrng for stream "stream". */ {
        return zrng[stream];
    }
}
